...
$ composer config repositories.weltpixel-magento2-weltpixel-newsletter git https://github.com/Weltpixel/magento2-weltpixel-newsletter.git
$ composer require weltpixel/magento2-weltpixel-newsletter:dev-master
```
