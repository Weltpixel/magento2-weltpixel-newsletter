    ...
    $.widget('weltpixel.newsletterpopup', {
        ...
        initPopup: function () {
            ...
            if (this.options.version != 3) {
                ...
                $('<div></div>', {id: this.options.lightboxDivId}).css("background", 'url(' +  backgroundImageUrl +')').appendTo('body');
            }
        ...
        initExitIntentPopup: function () {
            $('<div></div>', {id: this.options.exitIntentOverlayDivId}).appendTo('body');
            if (this.options.exitIntentVersion != 3) {
                $('<div></div>', {id: this.options.exitIntentLightboxDivId}).appendTo('body');
            } else {
                var backgroundImageUrl = $(this._getElementIdSelector(this.options.exitIntentContentId)).find('.image-background').attr('src');
                $('<div></div>', {id: this.options.exitIntentLightboxDivId}).css("background", 'url(' +  backgroundImageUrl +')').appendTo('body');
            }
